class RoomsController < ApplicationController
  before_action :set_room, only: [:show, :edit, :update, :destroy, :make_reservation]
  ...
  def make_reservation
    ...
    current_user.book! @room, time_start: from_ok, time_end: to_ok, amount: 1
  end
